...
- 新しい会話の開始
- **4つのモード切り替え**:
  - 課題解決モード: 問題の特定・分析・解決策・アクションプラン
  - 学習支援モード: COMPASS教材・理論学習・スキル向上・学習計画
  - 計画立案モード: 目標設定・週次計画・タスク整理・優先順位
  - 伴走補助モード: 進捗振り返り・モチベーション・成果確認・次ステップ
- **クイックプロンプト**: 各モードに最適化された4つの質問例（2×2グリッド表示）
